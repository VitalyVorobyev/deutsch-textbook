...
- Corrected the six rule-boundary clusters named above in articles, exercises and readings.
- Corrected awkward or underdetermined production models and bumped item revisions where the
  accepted/scored contract changed.
- Triaged all 13 pending renderings: one correct target-preserving variant was accepted and twelve

...
Today: **A1 93/93 · A2 300/300 · B1 164/164** claimed. The original 23-entry DTZ tail and the
eight complete teaching slices that closed it are recorded in
[`a1-b1-completeness-audit.md`](../curriculum/a1-b1-completeness-audit.md). B1 is `100% des
DTZ-Inventars`: DTZ is cumulative A2–B1 and is not asserted to enumerate every possible B1
grammar progression. Per [ADR 0015](../adrs/0015-provable-course-completeness.md),

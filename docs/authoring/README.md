...
The companion docs behind `CLAUDE.md`'s one-line rules. The digest and the full "before you do X,
read Y" map live in [`CLAUDE.md`](../../CLAUDE.md); the rows relevant to authoring are mirrored
here.

| If you are… | Read first |
| --- | --- |
| writing or revising a **topic article** (`## Erklärung` structure, paragraph size, `Kurz gesagt`) | [`article-prose.md`](article-prose.md) |
...
- [`article-prose.md`](article-prose.md) — how an explanation article is shaped, and the paragraph ceiling.

...
| **Pushed output / productive recall** (§12) | EN/RU→DE typed flashcards; `translate`; `listen`; open `write` with locally saved drafts | `write` logs practice evidence, not verified accuracy. Audit measured and unverified output separately. |
